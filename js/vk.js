...
//========================================
  ...
  var WidgetUpdate = async function (uids){
   ...
   var senditem = async function(id,cost,ostatok,item){
     ...
     if (item =="У пушистых не только лапки [За Ебаллы]"){
         mess = shapka+"http://vk.com/@tolchokgrigoreva-na-skolko-tebe-interesno";
     }else
     if(item =="Собутыльник на час [За Ебаллы]"){
          mess = shapka+"В ближайшее время тебе напишет админ.";
     }else
     if (item =="Ни одним репостом едины [За Ебаллы]"){
      mess = shapka+"В ближайшее время тебе напишет админ.";
     }else
     if (item =="Я тебя люблю [За Ебаллы]"){
      mess = shapka+"В ближайшее время тебе напишет админ.";
     }else{
